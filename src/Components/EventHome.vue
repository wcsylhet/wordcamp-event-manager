            ...
            <div class="box_header">
                <div class="box_head">
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                        ...
                        <el-breadcrumb-item style="font-size: 18px;">{{ event.title }}</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
            </div>
...
export default {
    ...
    computed: {
        isCheckedIn() {
            ...
            const event = this.attendee.events.find(item => item.id === this.event_id);
            return !!event?.id;
        }
    },
    methods: {
